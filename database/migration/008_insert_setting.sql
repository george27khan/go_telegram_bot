...
values ('start_hour_scheduler', 'График начала рабочего дня', '{"Mon": 9, "Tue": 9, "Wed": 9, "Thu": 9, "Fri": 9, "Sat": 9, "Sun": 9}'),
       ('end_hour_scheduler', 'График конца рабочего дня', '{"Mon": 18, "Tue": 18, "Wed": 18, "Thu": 18, "Fri": 18, "Sat": 16, "Sun": 16}');
